                                ...
                                <div class="social-login--content">
                                    ...
                                    <?php if (showStrategy('govbr', $config)) : ?>
                                        <a class="br-sign-in" href="<?php echo $app->createUrl('auth', 'govbr') ?>" style="background-color: #eee;color: black;">
                                            Entrar com
                                            <img class="br-sign-in-img" src="<?php $this->asset('img/govbr-colorido.png'); ?>" style="margin-left: 6px;width: 23% !important;-webkit-filter: none !important;filter: none !important;color:#000;"/>
                                        </a>
